class ModuleInstance
  class << self
    ...
    include Fastlane::Helper::IOSHelper
  end
end

describe Fastlane::Helper::IOSHelper do
  ...
  describe "constants" do
    it "defines APPLINKS" do
      expect(Fastlane::Helper::IOSHelper::APPLINKS).to eq "applinks"
    end

    it "defines ASSOCIATED_DOMAINS" do
      expect(Fastlane::Helper::IOSHelper::ASSOCIATED_DOMAINS).to eq "com.apple.developer.associated-domains"
    end

    it "defines CODE_SIGN_ENTITLEMENTS" do
      expect(Fastlane::Helper::IOSHelper::CODE_SIGN_ENTITLEMENTS).to eq "CODE_SIGN_ENTITLEMENTS"
    end

    it "defines DEVELOPMENT_TEAM" do
      expect(Fastlane::Helper::IOSHelper::DEVELOPMENT_TEAM).to eq "DEVELOPMENT_TEAM"
    end

    it "defines PRODUCT_BUNDLE_IDENTIFIER" do
      expect(Fastlane::Helper::IOSHelper::PRODUCT_BUNDLE_IDENTIFIER).to eq "PRODUCT_BUNDLE_IDENTIFIER"
    end

    it "defines RELEASE_CONFIGURATION" do
      expect(Fastlane::Helper::IOSHelper::RELEASE_CONFIGURATION).to eq "Release"
    end
  end
